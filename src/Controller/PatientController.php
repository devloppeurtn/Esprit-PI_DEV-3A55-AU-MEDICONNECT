...
class PatientController extends AbstractController
{
    ...
    public function rateMedecin(Request $request, string $medecinId): Response
    {
        ...
        $existingAvis = $this->avisRepo->findOneBy([
            'medecin' => $medecin,
            'patient' => $patient,
        ]);
        ...
        $form = $this->createForm(AvisMedecinFormType::class, $avis);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $message = $isEdit ? 'Votre avis a été mis à jour' : 'Merci pour votre avis !';
            $this->addFlash('success', $message);
            return $this->redirectToRoute('app_patient_index');
        }

        return $this->render('patient/rate_medecin.html.twig', [
            'form' => $form,
            'medecin' => $medecin,
            'isEdit' => $isEdit,
        ]);
    ...
    public function myRatings(): Response
    {
        ...
        $avis = $this->avisRepo->findBy(['patient' => $patient], ['dateCreation' => 'DESC']);

        return $this->render('patient/my_ratings.html.twig', [
            'avis' => $avis,
        ]);
    }
}
