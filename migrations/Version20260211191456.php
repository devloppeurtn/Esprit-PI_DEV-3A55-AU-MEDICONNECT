 ...
 */
final class Version20260211191456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reponse_utilisateur (id BINARY(16) NOT NULL, reponse_choisie VARCHAR(255) NOT NULL, est_correcte TINYINT NOT NULL, points_obtenus INT NOT NULL, date_reponse DATETIME NOT NULL, utilisateur_id INT NOT NULL, question_id BINARY(16) NOT NULL, INDEX IDX_14B756B6FB88E14F (utilisateur_id), INDEX IDX_14B756B61E27F6BF (question_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
